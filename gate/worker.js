// by9am access gate — Cloudflare Worker
...
const CRITERIA = `
We are building a private, high-signal early community for by9am. Fast-track ("expedited") people who are clearly:
...
export default {
  async fetch(req, env) {
    ...
    const system =
      `You are the access agent for by9am, an invite-only AI assistant. ` +
    ...
    if (!verdict) {
      return json({ decision: 'expedited', headline: `Welcome, ${first}`, reason: 'You look like a strong fit for by9am.' }, 200, origin);
    }
